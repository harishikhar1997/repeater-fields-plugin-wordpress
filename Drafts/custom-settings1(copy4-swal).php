...
class MyPlugin{
    ...
    wp_register_script( 'jquery', 'https://unpkg.com/sweetalert/dist/sweetalert.min.js');
    
    wp_enqueue_style( 'css-swal', 'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-sweetalert/1.0.1/sweetalert.css');

    wp_enqueue_style( 'css-swal2', 'https://cdnjs.cloudflare.com/ajax/libs/bootstrap-sweetalert/1.0.1/sweetalert.min.css');
